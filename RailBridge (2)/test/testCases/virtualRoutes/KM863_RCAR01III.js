...
const onDataReceived = (info) => {
  ...
  if(info.connected) {
    if(currentState === STATE['WAITING_CONNECTION']) {
      ...
      sendChanges({section: 5, remote: 12, full: false, connected: true, changed: [{index: 1, value: 0}, {index: 2, value: 0}, {index: 3, value: 0}]});
    ...
    else if(info.section === 5 && info.remote === 12 && info.port === 2 && info.value === 1) {
      // Cancel Route
      ...
      //Send AMV6 and AMV7 Normal
      sendChanges({section: 5, remote: 12, full: false, connected: true, changed: [{index: 52, value: 0}]});
    }
    ...
    else if(info.section === 5 && info.remote === 12 && info.port === 1 && info.value === 8) {
      // Requested Route
      ...
      if(currentState === STATE['LOCKED_ROUTE']) {
        ...
        // sendChanges({section: 5, remote: 12, full: false, connected: true, changed: [{index: 1, value: 64}]});
  
        seq_indications = 1;
        setTimeout(() => {
          console.debug('Send Route GRANTED - Virtual Route');
          //Send Route KM512.R_CE GRANTED - Virtual Route
          sendChanges({section: 5, remote: 12, full: false, connected: true, changed: [{index: 1, value: 64}, {index: 52, value: 32}]});
        ...
        setTimeout(() => {
          ...
          sendChanges({section: 5, remote: 12, full: false, connected: true, changed: [{index: 1, value: 0}]});
        }, INDICATION_INTERVAL * seq_indications);
      ...
      if(currentState === STATE['REAL_ROUTE_GRANTED']) {
        ...
        setTimeout(() => {
          ...
          sendChanges({section: 5, remote: 12, full: false, connected: true, changed: [{index: 52, value: 32}]});
        }, INDICATION_INTERVAL * seq_indications);
        ...
        setTimeout(() => {
          ...
          sendChanges({section: 5, remote: 12, full: false, connected: true, changed: [{index: 52, value: 64}]});
        }, INDICATION_INTERVAL * seq_indications);
      ...
      if(currentState === STATE['REAL_ROUTE_REGISTERED']) {
        ...
        sendChanges({section: 5, remote: 12, full: false, connected: true, changed: [{index: 1, value: 128}]});
      ...
      if(currentState === STATE['REAL_ROUTE_TIMELOCKED']) {
        ...
        setTimeout(() => {
          ...
          sendChanges({section: 5, remote: 12, full: false, connected: true, changed: [{index: 3, value: 1}]});
        }, INDICATION_INTERVAL * seq_indications);
