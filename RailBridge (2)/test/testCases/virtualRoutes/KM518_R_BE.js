...
const onDataReceived = (info) => {
  ...
  if(info.connected) {
    if(currentState === STATE['WAITING_CONNECTION']) {
      ...
      //Send Route KM518.R_BE AVAILABLE - Virtual Route Mirror
      sendChanges({section: 4, remote: 20, full: false, connected: true, changed: [{index: 52, value: 0}]});
      ...
      sendChanges({section: 4, remote: 20, full: false, connected: true, changed: [{index: 3, value: 0}]});
    ...
    else if(info.section === 4 && info.remote === 20 && info.port === 1 && info.value === 8) {
        ...
        if(currentState === STATE['LOCKED_ROUTE']) {
          ...
          setTimeout(() => {
            ...
            sendChanges({section: 4, remote: 20, full: false, connected: true, changed: [{index: 1, value: 64}, {index: 52, value: 32}]});
          ...
          setTimeout(() => { 
            ...
            sendChanges({section: 4, remote: 20, full: false, connected: true, changed: [{index: 12, value: 160}]});
          }, INDICATION_INTERVAL * seq_indications);
